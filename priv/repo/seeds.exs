...
DApp.Repo.insert(%DApp.Schema.Semester{id: 1, code: "S01", program_id: "bscs"})
DApp.Repo.insert(%DApp.Schema.Semester{id: 2, code: "S02", program_id: "bscs"})
DApp.Repo.insert(%DApp.Schema.Semester{id: 3, code: "S03", program_id: "bscs"})
DApp.Repo.insert(%DApp.Schema.Semester{id: 4, code: "S04", program_id: "bscs"})
